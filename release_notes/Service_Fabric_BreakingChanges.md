...
* [Breaking Changes of 90CU21 and 82CU51](#breaking-changes-of-90cu21-and-82cu51)
...
| **Windows - 7.2.432.9590<br>Ubuntu 16 - 7.2.431.1804<br>Ubuntu 18 - 7.2.431.1804** | .Net Core Runtime EOL |.NET core runtime LTS 2.1 runtime will go out of support from Aug 21, 2021. Service Fabric releases after that date will drop support for Service Fabric apps running with .NET core 2.1 runtime. Service Fabric .NET SDK will take a dependency on .Net runtime 3.* features to support Service Fabric .NET core apps.  This has no impact on Service Fabric .NET Framework SDK. 
