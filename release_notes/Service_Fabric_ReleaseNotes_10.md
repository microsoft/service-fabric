...
|**Windows - 10.0.1779.959<br>Ubuntu 18 - 10.0.1694.1<br>Ubuntu 20 - 10.0.1694.1** | **Feature** | Diagnostics | **Brief Description**: The repair job timeline history has been updated to fix the incorrect ordering of claimed and approved actions.<br>**Feature**: <br> **Solution**: <br> **Documentation Reference**: <br>
