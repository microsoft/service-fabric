...
|**Windows - 10.0.1779.959<br>Ubuntu 18 - 10.0.1694.1<br>Ubuntu 20 - 10.0.1694.1** | **Feature** | KVS | **Brief Description**:  The legacy auto-compaction settings, including CompactionThresholdInMB, FreePageSizeThresholdInMB, and CompactionProbabilityInPercent, have been removed from the codebase and are no longer utilized for determining auto-compaction at open. Instead, a new setting, FreePageSizeThresholdInPercent, introduced in versions 9.1CU3 and 9.0CU9, is now used for determining auto-compaction at open.<br>**Feature**: Auto-compaction will now be based on the FreePageSizeThresholdInPercent setting, and any existing configurations using the legacy auto-compaction settings will be disregarded. <br>**Solution/Fix**: Auto-compaction at open is now determined by the FreePageSizeThresholdInPercent setting. <br> **Breaking Change**:  Existing overrides of the legacy auto-compaction settings will be ignored. <br> **Documentation Reference**: <br>
