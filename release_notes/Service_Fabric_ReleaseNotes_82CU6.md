...
If Service Fabric cluster has periodic backup enabled on any of the app/service/partition, post upgrade to 8.2.1686.9590, BRS will fail to deserialize old BackupMetadata. BRS will also stop taking backup and restore on the partition/service/app in question with changes in new release even though user app, cluster and BRS shows healthy.
