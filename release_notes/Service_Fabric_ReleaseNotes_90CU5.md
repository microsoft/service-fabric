...
| **Windows - 9.0.1155.9590<br>Ubuntu 18 - 9.0.1148.1<br>Ubuntu 20 - 9.0.1148.1** | **Bug** | Backup Restore Service(BRS) | **Brief Description**: Breaking change of BRS introduced in 8.2.1686.9590 / 9.0.1107.9590 / 9.1.1387.9590 that failed BRS to deserialize old metadata is now fixed in this release. The backup and restore on the partition/service/app works as expected.
