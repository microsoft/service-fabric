...
//        static const KTagType _ThisTypeTag;
    ...
    public:
        ...
        StartQueryAsync(
            ...
            __in  KIDomNode::SPtr RequestHeaders,
            __out KIDomNode::SPtr& ResponseHeaders,
            __out KArray<KIDomNode::SPtr>& ResponseBodies,
    ...
    protected:
        ...
        class ManagementRequestContext : public KAsyncContextBase
        {
            ...
            protected:
                ...
                // a new request. Any derived class that overides this
                // method must insure that this base method is also
                // invoked.
                //
                virtual NTSTATUS InitializeForUse(
                    __in Verbs Verb,
                    __in KUriView& Target
                    );
            ...
            protected:
                ...
                //
                // This is a standard KTL OnReuse() method. It may be
                // overridden and if so the derived method must also be
                // sure the derived OnReuse() is invoked.
                //
                virtual VOID
                OnReuse(
                    );
