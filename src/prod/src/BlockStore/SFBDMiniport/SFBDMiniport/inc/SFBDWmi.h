...
This file includes WMI declarations for Service Fabric BlockStore Device's interaction with the BlockStore Service.
...
// SFBDMPDriver - SFBDMPDriver
// SFBDMPDriver Schema
#define SFBDMPDriverGuid \
    { 0x33168f61,0x67a8,0x408e, { 0xb2,0x62,0x12,0x40,0xaa,0xc0,0x34,0x47 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(SFBDMPDriver_GUID, \
            0x33168f61,0x67a8,0x408e,0xb2,0x62,0x12,0x40,0xaa,0xc0,0x34,0x47);
#endif


typedef struct _SFBDMPDriver
{
    // The Answer
    ULONG TheAnswer;
    #define SFBDMPDriver_TheAnswer_SIZE sizeof(ULONG)
    #define SFBDMPDriver_TheAnswer_ID 1

    // The Next Answer
    ULONG TheNextAnswer;
    #define SFBDMPDriver_TheNextAnswer_SIZE sizeof(ULONG)
    #define SFBDMPDriver_TheNextAnswer_ID 2

    // SRBs seen
    ULONG SRBsSeen;
    #define SFBDMPDriver_SRBsSeen_SIZE sizeof(ULONG)
    #define SFBDMPDriver_SRBsSeen_ID 3

    // WMI SRBs seen
    ULONG WMISRBsSeen;
    #define SFBDMPDriver_WMISRBsSeen_SIZE sizeof(ULONG)
    #define SFBDMPDriver_WMISRBsSeen_ID 4

} SFBDMPDriver, *PSFBDMPDriver;

#define SFBDMPDriver_SIZE (FIELD_OFFSET(SFBDMPDriver, WMISRBsSeen) + SFBDMPDriver_WMISRBsSeen_SIZE)

// SFBDMPDriver2 - SFBDMPDriver2
// SFBDMPDriver Schema2
#define SFBDMPDriver2Guid \
    { 0x33168f62,0x67a8,0x408e, { 0xb2,0x62,0x12,0x40,0xaa,0xc0,0x34,0x47 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(SFBDMPDriver2_GUID, \
            0x33168f62,0x67a8,0x408e,0xb2,0x62,0x12,0x40,0xaa,0xc0,0x34,0x47);
#endif


typedef struct _SFBDMPDriver2
{
    // Number of array elements
    ULONG NumberElements;
    #define SFBDMPDriver2_NumberElements_SIZE sizeof(ULONG)
    #define SFBDMPDriver2_NumberElements_ID 1

    // The array
    ULONG UlongArray[1];
    #define SFBDMPDriver2_UlongArray_ID 2

} SFBDMPDriver2, *PSFBDMPDriver2;

// SFBDMPDriverSrbActivity - SFBDMPDriverSrbActivity
// Performance counter class that keeps counts of SRBs
#define SFBDMPDriverSrbActivityGuid \
    { 0x33168f63,0x67a8,0x408e, { 0xb2,0x62,0x12,0x40,0xaa,0xc0,0x34,0x47 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(SFBDMPDriverSrbActivity_GUID, \
            0x33168f63,0x67a8,0x408e,0xb2,0x62,0x12,0x40,0xaa,0xc0,0x34,0x47);
#endif


typedef struct _SFBDMPDriverSrbActivity
{
    // Count of CREATE SRBs received
    ULONG TotalCreateSRBs;
    #define SFBDMPDriverSrbActivity_TotalCreateSRBs_SIZE sizeof(ULONG)
    #define SFBDMPDriverSrbActivity_TotalCreateSRBs_ID 1

    // Count of CLOSE SRBs received
    ULONG TotalCloseSRBs;
    #define SFBDMPDriverSrbActivity_TotalCloseSRBs_SIZE sizeof(ULONG)
    #define SFBDMPDriverSrbActivity_TotalCloseSRBs_ID 2

    // Count of IOCTL SRBs received
    ULONG TotalIoCtlSrbs;
    #define SFBDMPDriverSrbActivity_TotalIoCtlSrbs_SIZE sizeof(ULONG)
    #define SFBDMPDriverSrbActivity_TotalIoCtlSrbs_ID 3

} SFBDMPDriverSrbActivity, *PSFBDMPDriverSrbActivity;

#define SFBDMPDriverSrbActivity_SIZE (FIELD_OFFSET(SFBDMPDriverSrbActivity, TotalIoCtlSrbs) + SFBDMPDriverSrbActivity_TotalIoCtlSrbs_SIZE)
