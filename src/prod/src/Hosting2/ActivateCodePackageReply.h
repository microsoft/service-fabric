...
namespace Hosting2
{
    class ActivateCodePackageReply : public Serialization::FabricSerializable
    {
    public:
        ActivateCodePackageReply();
        ActivateCodePackageReply(Common::ErrorCode const & errorCode);
