...
namespace Hosting2
{
    ...
    public:
        ...
        private:
            ...
            void GetHealth_CallerHoldsLock(__out bool & shouldRaiseEvent, __out Common::SystemHealthReportCode::Enum & reportCode, __out FABRIC_SEQUENCE_NUMBER & sequenceNumber);
    ...
    public:
        CodePackage(
            ...
            std::vector<std::wstring> const & guestServiceTypes = std::vector<wstring>());
        ...
        __declspec(property(get = get_GuestServiceTypeNames)) std::vector<std::wstring> const & GuestServiceTypes;
        std::vector<std::wstring> const & get_GuestServiceTypeNames() const { return this->guestServiceTypes_; }
    ...
    private:
        ...
        Common::TimeSpan GetDueTime(ServiceModel::CodePackageEntryPointStatistics stats, Common::TimeSpan runInterval);                
        ...
        Common::ErrorCode GetEntryPoint(int64 const instanceIdOfCodePackageInstance, __out CodePackageInstanceSPtr & entryPoint);
    ...
    private:        
        ...
        vector<std::wstring> const guestServiceTypes_;
