...
namespace Hosting2
{
    class DeactivateCodePackageReply : public Serialization::FabricSerializable
    {
    public:
        DeactivateCodePackageReply();
        DeactivateCodePackageReply(Common::ErrorCode const & errorCode);
