...
namespace Hosting2
{
    class InvalidateLeaseReplyBody : public Serialization::FabricSerializable
    {
    public:
        InvalidateLeaseReplyBody();
        InvalidateLeaseReplyBody(Common::ErrorCode const & errorCode);
