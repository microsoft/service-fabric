...
namespace Hosting2
{
    ...
    public:
        ProcessActivationContext(
            ...
            bool hasConsole,
            DWORD debuggerProcId = 0,
            Common::ProcessHandleUPtr && debuggerprocessHandle = nullptr,
            Common::HandleUPtr && debuggerThreadHandle = nullptr,
            Common::ProcessWaitSPtr const & debugprocessMonitor = nullptr);
        ...
        static void CreateProcessActivationContext(
            Common::ProcessWaitSPtr const & processMonitor,
            Common::ProcessHandleUPtr && processHandle,
            Common::JobHandleUPtr && jobHandle,
            Common::HandleUPtr && threadHandle,
