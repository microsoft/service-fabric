...
namespace Hosting2
{
    class RegisterFabricRuntimeReply : public Serialization::FabricSerializable
    {
    public:
        RegisterFabricRuntimeReply();
        RegisterFabricRuntimeReply(Common::ErrorCode const & errorCode);
