...
namespace Hosting2
{
    class RegisterServiceTypeReply : public Serialization::FabricSerializable
    {
    public:
        RegisterServiceTypeReply();
        RegisterServiceTypeReply(Common::ErrorCode const & errorCode);
