...
namespace Hosting2
{
    class UnregisterApplicationHostReply : public Serialization::FabricSerializable
    {
    public:
        UnregisterApplicationHostReply();
        UnregisterApplicationHostReply(Common::ErrorCode const & errorCode);
