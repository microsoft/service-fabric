...
namespace Hosting2
{
    class UnregisterFabricRuntimeReply : public Serialization::FabricSerializable
    {
    public:
        UnregisterFabricRuntimeReply();
        UnregisterFabricRuntimeReply(Common::ErrorCode const & errorCode);
