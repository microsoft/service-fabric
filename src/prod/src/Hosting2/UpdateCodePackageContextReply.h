...
namespace Hosting2
{
    class UpdateCodePackageContextReply : public Serialization::FabricSerializable
    {
    public:
        UpdateCodePackageContextReply();
        UpdateCodePackageContextReply(Common::ErrorCode const & errorCode);
