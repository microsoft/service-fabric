...
namespace Management
{
    namespace BackupRestoreAgentComponent
    {
        ...
        {
            class FileShareUploadBackupAsyncOperation : public FileShareBackupCopierAsyncOperationBase
            {
                DENY_COPY(FileShareUploadBackupAsyncOperation)
            public:
                FileShareUploadBackupAsyncOperation(
