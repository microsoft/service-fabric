...
#define CM_DEL_QUERY_TRACE(table_name, trace_name, trace_id, trace_level, trace_format, ...) \
        ...
        class ClusterManagerEventSource
        {
            ...
            APPLICATIONS_OPERATIONAL_TRACE(ApplicationUpgradeRollbackStartOperational, L"ApplicationUpgradeRollbackStarted", OperationalUpgradeCategory, ClusterManager, 183, Info, "Application rollback start: Application = {1}, Application Type = {2}, Target Application Type Version = {4}, Failure Reason = {5}, Overall Elapsed Time = {6}", "applicationTypeName", "currentApplicationTypeVersion", "applicationTypeVersion", "failureReason", "overallUpgradeElapsedTimeInMs"),
            APPLICATIONS_OPERATIONAL_TRACE(ApplicationUpgradeRollbackCompleteOperational, L"ApplicationUpgradeRollbackCompleted", OperationalUpgradeCategory, ClusterManager, 184, Info, "Application rollback completed: Application = {1}, Application Type = {2}, Target Application Type Version = {3}, Failure Reason = {4}, Overall Elapsed Time = {5}", "applicationTypeName", "applicationTypeVersion", "failureReason", "overallUpgradeElapsedTimeInMs"),
            ...
            CLUSTER_OPERATIONAL_TRACE(ClusterUpgradeRollbackStartOperational, L"ClusterUpgradeRollbackStarted", OperationalUpgradeCategory, ClusterManager, 189, Info, "Cluster rollback start: Target Cluster Version = {1}, Failure Reason = {2}, Overall Elapsed Time = {3}", "targetClusterVersion", "failureReason", "overallUpgradeElapsedTimeInMs"),
            CLUSTER_OPERATIONAL_TRACE(ClusterUpgradeRollbackCompleteOperational, L"ClusterUpgradeRollbackCompleted", OperationalUpgradeCategory, ClusterManager, 190, Info, "Cluster rollback completed: Target Cluster Version = {1}, Failure Reason = {2}, Overall Elapsed Time = {3}", "targetClusterVersion", "failureReason", "overallUpgradeElapsedTimeInMs"),
