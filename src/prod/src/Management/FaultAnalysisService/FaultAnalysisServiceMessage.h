...
namespace Management
{
    ...
    {
        class FaultAnalysisServiceMessage
        {
        public:
        ...
        private:
            ...
            static void WrapForFaultAnalysisService(__inout Transport::Message &);
            ...
            static Transport::MessageUPtr CreateMessage(std::wstring const & action)
            {
                ...
                FaultAnalysisServiceMessage::SetHeaders(*message, action);
            ...
            static Transport::MessageUPtr CreateRoutedRequestMessage(std::wstring const & action, TBody const & body)
            {
                ...
                WrapForFaultAnalysisService(*message);
                return std::move(message);
            }
