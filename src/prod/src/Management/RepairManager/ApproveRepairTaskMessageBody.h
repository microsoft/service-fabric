...
namespace Management
{
    ...
    {
        class ApproveRepairTaskMessageBody : public ServiceModel::ClientServerMessageBody
        {
        public:
            ApproveRepairTaskMessageBody()
                : taskId_()
                , version_(0)
                , scope_()
            {
            ...
            Common::ErrorCode FromPublicApi(FABRIC_REPAIR_APPROVE_DESCRIPTION const & publicDescription)
            {
