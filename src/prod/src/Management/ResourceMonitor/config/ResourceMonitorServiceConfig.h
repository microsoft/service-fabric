...
namespace ResourceMonitor
{
    ...
    public:
        ...
        INTERNAL_CONFIG_ENTRY(Common::TimeSpan, L"ResourceMonitorService", ResourceMonitorInterval, Common::TimeSpan::FromSeconds(15), Common::ConfigEntryUpgradePolicy::Dynamic);
        ...
        INTERNAL_CONFIG_ENTRY(Common::TimeSpan, L"ResourceMonitorService", FabricHostCommunicationInterval, Common::TimeSpan::FromSeconds(50), Common::ConfigEntryUpgradePolicy::Dynamic);
        ...
        //Smoothing factors for both CPU and Memory
