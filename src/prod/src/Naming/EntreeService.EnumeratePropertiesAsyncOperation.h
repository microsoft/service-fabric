...
namespace Naming
{
    class EntreeService::EnumeratePropertiesAsyncOperation : public EntreeService::NamingRequestAsyncOperationBase
    {
    public:
    ...
    private:
        ...
        EnumeratePropertiesRequest enumeratePropertiesRequest_;
    };
}
