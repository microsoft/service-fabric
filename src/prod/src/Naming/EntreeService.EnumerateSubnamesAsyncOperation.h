...
namespace Naming
{
    class EntreeService::EnumerateSubnamesAsyncOperation : public EntreeService::NamingRequestAsyncOperationBase
    {
    public:
    ...
    private:
        ...
        EnumerateSubNamesRequest enumerateSubNamesRequest_;
    };
}
