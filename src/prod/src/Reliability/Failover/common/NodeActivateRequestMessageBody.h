...
{
    class NodeActivateRequestMessageBody : public Serialization::FabricSerializable
    {
    public:
        NodeActivateRequestMessageBody()
        {
        }

        NodeActivateRequestMessageBody(int64 sequenceNumber, bool isFromFmm)
