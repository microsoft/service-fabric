...
{
    class ResetPartitionLoadRequestMessageBody : public Serialization::FabricSerializable
    {
    public:

        ResetPartitionLoadRequestMessageBody()
        {
        }

        ResetPartitionLoadRequestMessageBody(Reliability::PartitionId const& partitionId)
