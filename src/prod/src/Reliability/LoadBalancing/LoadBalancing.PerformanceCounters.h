    ...
    namespace LoadBalancingComponent
    {
        ...
        public:
            ...
            BEGIN_COUNTER_SET_DEFINITION(
                ...
                COUNTER_DEFINITION(13, Common::PerformanceCounterType::AverageBase, L"#PLBScheduler Creation Actions Base",                       L"PLBScheduler Creation Actions Generated Denominator", noDisplay)
                COUNTER_DEFINITION(14, Common::PerformanceCounterType::AverageBase, L"PLBScheduler Creation Generation Duration Base",            L"PLBScheduler Creation Generation Duration Denominator", noDisplay)
                ...
                COUNTER_DEFINITION(17, Common::PerformanceCounterType::AverageBase, L"#PLBScheduler FastBalancing Actions Base",                  L"PLBScheduler FastBalancing Actions Generated Denominator", noDisplay)
                COUNTER_DEFINITION(18, Common::PerformanceCounterType::AverageBase, L"PLBScheduler FastBalancing Generation Duration Base",       L"PLBScheduler FastBalancing Generation Duration Denominator", noDisplay)
                COUNTER_DEFINITION(19, Common::PerformanceCounterType::AverageBase, L"#PLBScheduler SlowBalancing Actions Base",                  L"PLBScheduler SlowBalancing Actions Generated Denominator", noDisplay)
                COUNTER_DEFINITION(20, Common::PerformanceCounterType::AverageBase, L"PLBScheduler SlowBalancing Generation Duration Base",       L"PLBScheduler SlowBalancing Generation Duration Denominator", noDisplay)

                COUNTER_DEFINITION(38, Common::PerformanceCounterType::AverageBase, L"#PLBScheduler CreationWithMove Actions Base",               L"PLBScheduler CreationWithMove Actions Generated Denominator", noDisplay)
                COUNTER_DEFINITION(39, Common::PerformanceCounterType::AverageBase, L"PLBScheduler CreationWithMove Generation Duration Base",    L"PLBScheduler CreationWithMove Generation Duration Denominator", noDisplay)
                ...
                COUNTER_DEFINITION_WITH_BASE( 3, 13, Common::PerformanceCounterType::AverageCount64, L"#PLBScheduler Creation Actions",                           L"Moving average of PLBScheduler Creation Actions generated by the PLB during one Refresh")
                COUNTER_DEFINITION_WITH_BASE( 4, 14, Common::PerformanceCounterType::AverageCount64, L"PLBScheduler Creation Generation Duration",                L"Moving average of Time in milliseconds it took the PLB to generate the PLBScheduler Creation Actions")
                ...
                COUNTER_DEFINITION_WITH_BASE( 7, 17, Common::PerformanceCounterType::AverageCount64, L"#PLBScheduler FastBalancing Actions",                      L"Moving average of PLBScheduler FastBalancing Actions generated by the PLB during one Refresh")
                COUNTER_DEFINITION_WITH_BASE( 8, 18, Common::PerformanceCounterType::AverageCount64, L"PLBScheduler FastBalancing Generation Duration",           L"Moving average of Time in milliseconds it took the PLB to generate the PLBScheduler FastBalancing Actions")
                COUNTER_DEFINITION_WITH_BASE( 9, 19, Common::PerformanceCounterType::AverageCount64, L"#PLBScheduler SlowBalancing Actions",                      L"Moving average of PLBScheduler SlowBalancing Actions generated by the PLB during one Refresh")
                COUNTER_DEFINITION_WITH_BASE(10, 20, Common::PerformanceCounterType::AverageCount64, L"PLBScheduler SlowBalancing Generation Duration",           L"Moving average of Time in milliseconds it took the PLB to generate the PLBScheduler SlowBalancing Actions")
                ...
                COUNTER_DEFINITION_WITH_BASE(28, 38, Common::PerformanceCounterType::AverageCount64, L"#PLBScheduler CreationWithMove Actions", L"Moving average of PLBScheduler CreationWithMove Actions generated by the PLB during one Refresh")
                COUNTER_DEFINITION_WITH_BASE(29, 39, Common::PerformanceCounterType::AverageCount64, L"PLBScheduler CreationWithMove Generation Duration", L"Moving average of Time in milliseconds it took the PLB to generate the PLBScheduler CreationWithMove Actions")
