...
namespace ServiceModel
{
    ...
    public:
        ...
        DeployedApplicationHealthStateFilter(DeployedApplicationHealthStateFilter && other);
        DeployedApplicationHealthStateFilter & operator = (DeployedApplicationHealthStateFilter && other);
