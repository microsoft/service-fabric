...
ETWSourceDestinationsDescription::ETWSourceDestinationsDescription() 
    : LocalStore(),
    FileStore(),
    AzureBlob()
{
...
ETWSourceDestinationsDescription::ETWSourceDestinationsDescription(
    ETWSourceDestinationsDescription const & other)
...
ETWSourceDestinationsDescription::ETWSourceDestinationsDescription(ETWSourceDestinationsDescription && other) 
...
ETWSourceDestinationsDescription const & ETWSourceDestinationsDescription::operator = (ETWSourceDestinationsDescription const & other)
{
    if (this != &other)
    {
...
ETWSourceDestinationsDescription const & ETWSourceDestinationsDescription::operator = (ETWSourceDestinationsDescription && other)
{
    if (this != &other)
    {
...
bool ETWSourceDestinationsDescription::operator == (ETWSourceDestinationsDescription const & other) const
{
    bool equals = true;
...
void ETWSourceDestinationsDescription::WriteTo(TextWriter & w, FormatOptions const &) const
{
    w.Write("ETWSourceDestinationsDescription { ");
...
void ETWSourceDestinationsDescription::ReadFromXml(
    XmlReaderUPtr const & xmlReader)
{
    ...
    while (localStoresAvailable)
    {
        if (xmlReader->IsStartElement(
            ...
            *SchemaNames::Namespace))
        {
            LocalStoreETWDescription localStore;
    ...
    while (fileStoresAvailable)
    {
        if (xmlReader->IsStartElement(
            ...
            *SchemaNames::Namespace))
        {
            FileStoreETWDescription fileStore;
    ...
    while (azureBlobsAvailable)
    {
        if (xmlReader->IsStartElement(
            ...
            *SchemaNames::Namespace))
        {
            AzureBlobETWDescription azureBlob;
...
ErrorCode ETWSourceDestinationsDescription::WriteToXml(XmlWriterUPtr const & xmlWriter)
{//<Destinations>
...
void ETWSourceDestinationsDescription::clear()
{
...
bool ETWSourceDestinationsDescription::empty()
{
