...
#define SM_TRACE( trace_name, trace_id, trace_level, ...) \
    ...
    class ServiceModelEventSource
    {
        ...
        SM_TRACE( ReportFaultReplyMessageBody, 31, Info, "Error = {1}", "contextSequenceId", "error")
        ...
        SM_TRACE( HealthEventTrace, 37, Info, "{1} {2} {3} {4} {5} {6} {7} expired={8} removeWhenExpired={9} lastOK={10} lastWarning={11} lastError={12}", "contextSequenceId", "sourceId", "property", "state", "timeToLive", "sequenceNumber", "sourceUtcTimestamp", "description", "lastModifiedUtcTimestamp", "isExpired", "removeWhenExpired", "lastOkTransitionAt", "lastWarningTransitionAt", "lastErrorTransitionAt")
        SM_TRACE( ServiceUpdateDescription, 40, Info, "flags={1} target={2} min={3} restart={4} ql={5} standby={6} correlations={7} placements={8} metrics={9} policies={10} movecost={11} repartition={12}", "contextSequenceId", "flags", "target", "min", "restart", "ql", "standby", "correlations", "placements", "metrics", "policies", "movecost", "repartition")
        ...
        DECLARE_SM_TRACE( ReportFaultReplyMessageBody, uint16, Common::ErrorCode)
