...
namespace Management
{
    namespace FaultAnalysisService
    {
        ...
        public:
            ...
            explicit WaitingEvent(WaitingEvent && other);
            WaitingEvent & operator = (WaitingEvent && other);
        ...
        DEFINE_CHAOS_EVENT_ACTIVATOR(WaitingEvent, FABRIC_CHAOS_EVENT_KIND_WAITING)
    }
}
