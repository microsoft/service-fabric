...
namespace Management
{
    ...
    {
        class InvokeQuorumLossResult : public ServiceModel::ClientServerMessageBody
        {
            DEFAULT_COPY_CONSTRUCTOR(InvokeQuorumLossResult)
        ...
        public:
            ...
            Common::ErrorCode FromPublicApi(FABRIC_PARTITION_QUORUM_LOSS_RESULT const &);
            void ToPublicApi(__in Common::ScopedHeap &, __out FABRIC_PARTITION_QUORUM_LOSS_RESULT &) const;
