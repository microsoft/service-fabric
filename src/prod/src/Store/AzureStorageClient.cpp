...
AzureStorageClient::AzureStorageClient(Store::PartitionedReplicaId const &, std::wstring &&) : impl_() { }

shared_ptr<AzureStorageClient> AzureStorageClient::Create(Store::PartitionedReplicaId const & id, std::wstring && rawConnection)
{
