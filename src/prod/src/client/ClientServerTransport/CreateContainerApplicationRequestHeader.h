...
{
    class CreateContainerApplicationRequestHeader :
        public Transport::MessageHeader<Transport::MessageHeaderId::CreateContainerApplicationRequest>,
        public Serialization::FabricSerializable
    {
    public:
        CreateContainerApplicationRequestHeader()
            : deploymentName_()
            , applicationName_()
            , repositoryUserName_()
            , repositoryPassword_()
        ...
        { 
            w.Write("CreateContainerApplicationRequestHeader{ ");
