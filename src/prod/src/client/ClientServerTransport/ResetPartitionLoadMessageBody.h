...
namespace Naming
{
    class ResetPartitionLoadMessageBody : public ServiceModel::ClientServerMessageBody
    {
    public:

        ResetPartitionLoadMessageBody()
        {
        }

        ResetPartitionLoadMessageBody(Reliability::PartitionId const& partitionId)
