...
namespace Data 
{
    namespace TStore
    {
        ...
        class UpdatedVersionedItem : public VersionedItem<TValue>
        {
            K_FORCE_SHARED(UpdatedVersionedItem)
        ...
        public:
            ...
            {
                NTSTATUS status;
                SPtr output = _new(VERSIONEDITEM_TAG, allocator) UpdatedVersionedItem();
            ...
            {
                return RecordKind::UpdatedVersion;
            }
        ...
        template <typename TValue>
        UpdatedVersionedItem<TValue>::UpdatedVersionedItem()
        {
        }
