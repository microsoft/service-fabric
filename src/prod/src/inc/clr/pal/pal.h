...
#if defined(_SAL_VERSION) && defined(USE_STDLIB) && defined(__in)
#define __PAL_H_SAL_UNDEF
// these defines are poison to the GNU / CLANG standard libs
#undef __in
#undef __out
#undef __null
#endif
...
typedef struct _STARTUPINFOW {
    ...
    LPWSTR lpDesktop;//_PAL_Undefined
    ...
    DWORD dwFlags;
    WORD wShowWindow;//_PAL_Undefined
...
typedef struct _PROCESS_INFORMATION {
    ...
    HANDLE hThread;
    DWORD dwProcessId;
    DWORD dwThreadId;//_PAL_Undefined
...
#ifdef PLATFORM_UNIX
/* Define a set of functions that have linux equivalent */
/* These functions are MS only functions deprecating stricmp et al in Windows environment
 * There are linux equivalents for the same
 */
#define _stricmp strcasecmp
#define _wcsicmp wcscasecmp
#endif

// Safe CRT function, not part of c++ standard libraries
...
#ifdef __PAL_H_SAL_UNDEF
#undef __PAL_H_SAL_UNDEF
// redefine SAL definitions
#define __in
#define __out
#define __null
#endif
