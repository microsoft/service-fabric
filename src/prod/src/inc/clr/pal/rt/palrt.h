...
#ifdef __cplusplus
#if !defined(__PLACEMENT_NEW_INLINE) && !defined(USE_STL)
...
// Macros for handling doubley linked lists. Picked up from list.h
...
// end Macros for handling doubly linked lists
...
#ifdef __PALRT_H_SAL_UNDEF
#undef __PALRT_H_SAL_UNDEF
