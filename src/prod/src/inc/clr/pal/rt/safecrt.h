...
#ifdef __GNUC__
#define SAFECRT_DEPRECATED(func) func __attribute__ ((deprecated))
#elif defined(_MSC_VER)
#define SAFECRT_DEPRECATED(func) __declspec(deprecated) func
#else
#pragma message("WARNING: You need to implement DEPRECATED for this compiler")
#define SAFECRT_DEPRECATED(func) func
#endif
