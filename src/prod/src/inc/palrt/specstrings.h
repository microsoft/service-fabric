...
#define __in_xcount(size)                                       __in_ _Pre_ __inexpressible_readableTo(size)
...
#define __deref_in                                              __in_ _Pre_ __deref __deref __readonly
...
// yihzhang: __deallocate is a method in ext/hash_map on Linux.
