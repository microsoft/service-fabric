...
*      is used in the right context. For example placing __in_ on a return 
...
*      LPCSTR pszString,  //  No annotation required, const implies __in_.
*      DWORD dwFlags,
*      __out int *piRet   // A pointer whose dereference will be filled in.
*  );
* 
*  void MyPaintingFunction(
*      __in_ HWND hwndControl,     //  An initialized read-only parameter.
...
#define __in_                                          _SAL_VERSION_CHECK(__in_)
...
*        b->sz = sz;                                             
*   }                                                            
*   void WriteBuf(__in_ FILE *fp,__in_ struct *buf_s b) {          
*     fwrite(b->buf,b->sz,sizeof(char),fp);                      
*   }                                                            
*   void ReadBuf(__in_ FILE *fp,__inout struct *buf_s b) {        
