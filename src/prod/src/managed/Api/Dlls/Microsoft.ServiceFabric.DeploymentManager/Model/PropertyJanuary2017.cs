...
namespace Microsoft.ServiceFabric.DeploymentManager.Model
{
    ...
    internal class PropertyJanuary2017 : PropertyBase
    {
        public SecurityJanuary2017 Security
        {
            get;
            set;
        }
        ...
        internal override void UpdateUserConfig(IUserConfig userConfig, List<NodeDescriptionGA> nodes)
        {
            ...
            userConfig.ReliabilityLevel = this.ReliabilityLevel == ReliabilityLevel.Invalid ? ReliabilityLevelExtension.GetReliabilityLevel(userConfig.TotalPrimaryNodeTypeNodeCount) : this.ReliabilityLevel;
        }
