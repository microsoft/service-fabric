...
namespace System.Fabric.Testability.Client.Requests
{
    ...
    public class ConfigurationUpgradeFabricRequest : FabricRequest
    {
        ...
        public ConfigurationUpgradeDescription UpgradeDescription
        {
            get;
            private set;
        }
        ...
        {
            this.OperationResult = await this.FabricClient.UpgradeFabricStandaloneAsync(this.UpgradeDescription, this.Timeout, cancellationToken);
        }
