...
namespace System.Fabric.Testability.Client.Requests
{
    ...
    public class DeactivateNodeRequest : FabricRequest
    {
        public DeactivateNodeRequest(
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "Deactivate node {0} with intent {1} with timeout {2}", this.NodeName, this.DeactivationIntent, this.Timeout);
        }
