...
namespace System.Fabric.Data.StateProviders
{
    ...
    /// <summary>
    /// Computes CRC64 for a given payload.
    /// </summary>
    public static class CRC64
    {
        ...
        /// CRC table.
        /// </summary>
        static readonly ulong[] crc64_table = new ulong[256] 
        {
        ...
        public static string ToCRC64String(byte[] value)
        {
            ...
            for (int i = 0; i < value.Length; i++)
            {
                ...
                crc = CRC64.crc64_table[tableIndex] ^ (crc << 8);
            }
            ulong crc64 = crc ^ 0xffffffffffffffff;
