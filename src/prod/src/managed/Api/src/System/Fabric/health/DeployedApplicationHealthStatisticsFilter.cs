...
namespace System.Fabric.Health
{
    ...
    /// to specify whether the health statistics should be returned as part of <see cref="System.Fabric.Health.DeployedApplicationHealth"/>.</remarks>
    public sealed class DeployedApplicationHealthStatisticsFilter
    {
        /// <summary>
        /// <para>Initializes a new instance of the <see cref="System.Fabric.Health.DeployedApplicationHealthStatisticsFilter" /> class.</para>
        /// </summary>
        public DeployedApplicationHealthStatisticsFilter()
        {
        }
        ...
        {
            var nativeFilter = new NativeTypes.FABRIC_DEPLOYED_APPLICATION_HEALTH_STATISTICS_FILTER();
