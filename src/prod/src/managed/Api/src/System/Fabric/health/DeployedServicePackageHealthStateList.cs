...
namespace System.Fabric.Health
{
    ...
    /// <summary>
    /// <para>Represents a collection of <see cref="System.Fabric.Health.DeployedServicePackageHealthState" /> that can be individually accessed by index.</para>
    /// </summary>
    public sealed class DeployedServicePackageHealthStateList : IList<DeployedServicePackageHealthState>
    {
        IList<DeployedServicePackageHealthState> list;

        internal DeployedServicePackageHealthStateList()
            : this(new List<DeployedServicePackageHealthState>())
        {
        }

        internal DeployedServicePackageHealthStateList(IList<DeployedServicePackageHealthState> list)
        {
            this.list = list;
        }
        ...
        /// </returns>
        public int IndexOf(DeployedServicePackageHealthState item)
        {
        ...
        /// </param>
        public void Insert(int index, DeployedServicePackageHealthState item)
        {
        ...
        /// </param>
        /// <returns>
        /// <para>The <see cref="System.Fabric.Health.DeployedServicePackageHealthState" /> at the specified index.</para>
        /// </returns>
        public DeployedServicePackageHealthState this[int index]
        {
            get
            {
        ...
        /// </param>
        public void Add(DeployedServicePackageHealthState item)
        {
            this.list.Add(item);
        }
        ...
        /// </returns>
        public bool Contains(DeployedServicePackageHealthState item)
        {
        ...
        /// </param>
        public void CopyTo(DeployedServicePackageHealthState[] array, int arrayIndex)
        {
        ...
        /// </summary>
        /// <value>
        /// <para>An <see cref="System.Int32" /> representing the number of elements.</para>
        /// </value>
        public int Count
        {
        ...
        /// </returns>
        public bool Remove(DeployedServicePackageHealthState item)
        {
        ...
        /// </returns>
        public IEnumerator<DeployedServicePackageHealthState> GetEnumerator()
        {
        ...
        internal static unsafe DeployedServicePackageHealthStateList FromNativeList(
            NativeTypes.FABRIC_DEPLOYED_SERVICE_PACKAGE_HEALTH_STATE_LIST* nativeList)
        {
            var retval = new DeployedServicePackageHealthStateList();

            var nativeItemArray = (NativeTypes.FABRIC_DEPLOYED_SERVICE_PACKAGE_HEALTH_STATE*)nativeList->Items;
            for (int i = 0; i < nativeList->Count; ++i)
            {
                var nativeItem = *(nativeItemArray + i);
                var item = DeployedServicePackageHealthState.FromNative(nativeItem);
                if (item != null)
                {
                    retval.Add(item);
                }
