...
namespace System.Fabric.Health
{
    ...
    /// <summary>
    /// <para>Represents a collection of <see cref="System.Fabric.Health.NodeHealthState" /> that can be individually accessed by index.</para>
    /// </summary>
    public sealed class NodeHealthStateList : IList<NodeHealthState>
    {
        IList<NodeHealthState> list;

        internal NodeHealthStateList()
            : this(new List<NodeHealthState>())
        {
        }

        internal NodeHealthStateList(IList<NodeHealthState> list)
        {
            this.list = list;
        }
        ...
        /// </returns>
        public int IndexOf(NodeHealthState item)
        {
        ...
        /// </param>
        public void Insert(int index, NodeHealthState item)
        {
        ...
        /// </returns>
        public NodeHealthState this[int index]
        {
            get
            {
        ...
        /// </param>
        public void Add(NodeHealthState item)
        {
            this.list.Add(item);
        }
        ...
        /// </returns>
        public bool Contains(NodeHealthState item)
        {
        ...
        /// </param>
        public void CopyTo(NodeHealthState[] array, int arrayIndex)
        {
        ...
        /// </returns>
        public bool Remove(NodeHealthState item)
        {
        ...
        /// </returns>
        public IEnumerator<NodeHealthState> GetEnumerator()
        {
        ...
        internal static unsafe NodeHealthStateList FromNativeList(
            NativeTypes.FABRIC_NODE_HEALTH_STATE_LIST* nativeList)
        {
            var retval = new NodeHealthStateList();

            var nativeItemArray = (NativeTypes.FABRIC_NODE_HEALTH_STATE*)nativeList->Items;
            for (int i = 0; i < nativeList->Count; ++i)
            {
                var nativeItem = *(nativeItemArray + i);
                var item = NodeHealthState.FromNative(nativeItem);
                if (item != null)
                {
                    retval.Add(item);
                }
