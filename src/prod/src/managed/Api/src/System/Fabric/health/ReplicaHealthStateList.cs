...
namespace System.Fabric.Health
{
    ...
    /// <summary>
    /// <para>Represents a collection of <see cref="System.Fabric.Health.ReplicaHealthState" /> that can be individually accessed by index.</para>
    /// </summary>
    public sealed class ReplicaHealthStateList : IList<ReplicaHealthState>
    {
        IList<ReplicaHealthState> list;

        internal ReplicaHealthStateList()
            : this(new List<ReplicaHealthState>())
        {
        }

        internal ReplicaHealthStateList(IList<ReplicaHealthState> list)
        {
            this.list = list;
        }
        ...
        /// </returns>
        public int IndexOf(ReplicaHealthState item)
        {
        ...
        /// </param>
        public void Insert(int index, ReplicaHealthState item)
        {
        ...
        /// </param>
        /// <returns>
        /// <para>Returns <see cref="System.Fabric.Health.ReplicaHealthState" /> at the specified index.</para>
        /// </returns>
        public ReplicaHealthState this[int index]
        {
            get
            {
        ...
        /// </param>
        public void Add(ReplicaHealthState item)
        {
            this.list.Add(item);
        }
        ...
        /// </returns>
        public bool Contains(ReplicaHealthState item)
        {
        ...
        /// </param>
        public void CopyTo(ReplicaHealthState[] array, int arrayIndex)
        {
        ...
        /// </returns>
        public bool Remove(ReplicaHealthState item)
        {
        ...
        /// </returns>
        public IEnumerator<ReplicaHealthState> GetEnumerator()
        {
