    ...
    internal class CheckpointManager
    {
            ...
            string traceDirectory)
        {
            ...
            if (!string.IsNullOrEmpty(etlPath))
            {
                return Path.Combine(
                    traceDirectory,
                    EtlInMemoryProducerConstants.LastEtlReadDirectory);
            }
        ...
        private class LastEndTimeFileParameters
        {
            ...
            public void WriteLastEndTime()
            {
                ...
                this.Writer.WriteLine(EtlInMemoryProducerConstants.LastEndTimeFormatVersionString);
            ...
            public void ReadLastEndTime()
            {
                ...
                if (success)
                {
                    if (false == versionLine.Equals(EtlInMemoryProducerConstants.LastEndTimeFormatVersionString))
                    {
                        this.traceSource.WriteError(
                            this.logSourceId,
                            ...
                            this.FileName,
                            versionLine,
                            EtlInMemoryProducerConstants.LastEndTimeFormatVersionString);
                        success = false;
                    }
                }
