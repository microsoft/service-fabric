...
namespace FabricDCA
{
    ...
    internal class MdsEtwEventUploaderPerformance : IDisposable
    {
        // Constants
        private const string TraceTypePerformance = "MdsUploaderPerformance";
        ...
        internal MdsEtwEventUploaderPerformance()
        {
        ...
        internal void DtrReadPassBegin()
        {
