...
namespace FabricDCA
{
    ...
    internal static class MdsFileProducerConstants
    {
        ...
        internal const string BookmarkBatchSizeParamName = "BookmarkBatchSize";
        ...
        internal const int DefaultBookmarkBatchSize = 100;
