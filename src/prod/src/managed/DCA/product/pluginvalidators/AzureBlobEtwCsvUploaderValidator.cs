...
namespace FabricDCA 
{
    ...
    // ETW CSV files in the cluster manifest
    public class AzureBlobEtwCsvUploaderValidator : ClusterManifestBlobSettingsValidator, IDcaAzureSettingsValidator
    {
        ...
        public AzureBlobEtwCsvUploaderValidator()
        {
