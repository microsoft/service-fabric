...
namespace EventsStore.EventsModels.Application
{
    ...
    [JsonObject("ApplicationHealthReportExpired")]
    public sealed class ApplicationHealthReportExpiredEvent : ApplicationEvent
    {
        public ApplicationHealthReportExpiredEvent(ApplicationHealthReportExpiredTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.ApplicationName)
        {
