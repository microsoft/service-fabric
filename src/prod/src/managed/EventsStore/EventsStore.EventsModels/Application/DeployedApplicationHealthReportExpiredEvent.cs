...
namespace EventsStore.EventsModels.Application
{
    ...
    [JsonObject("DeployedApplicationHealthReportExpired")]
    public sealed class DeployedApplicationHealthReportExpiredEvent : ApplicationEvent
    {
        public DeployedApplicationHealthReportExpiredEvent(DeployedApplicationHealthReportExpiredTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.ApplicationName)
        {
