...
namespace EventsStore.EventsModels.Application
{
    ...
    [JsonObject("DeployedServicePackageNewHealthReport")]
    public sealed class DeployedServiceHealthReportCreatedEvent : ApplicationEvent
    {
        public DeployedServiceHealthReportCreatedEvent(DeployedServiceHealthReportCreatedTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.ApplicationName)
        {
