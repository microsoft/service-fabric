...
namespace EventsStore.EventsModels.Cluster
{
    ...
    [JsonObject("ClusterNewHealthReport")]
    public sealed class ClusterHealthReportCreatedEvent : ClusterEvent
    {
        public ClusterHealthReportCreatedEvent(ClusterHealthReportCreatedTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category)
        {
