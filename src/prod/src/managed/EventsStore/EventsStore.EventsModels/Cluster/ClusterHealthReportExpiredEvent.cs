...
namespace EventsStore.EventsModels.Cluster
{
    ...
    [JsonObject("ClusterHealthReportExpired")]
    public sealed class ClusterHealthReportExpiredEvent : ClusterEvent
    {
        public ClusterHealthReportExpiredEvent(ClusterHealthReportExpiredTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category)
        {
