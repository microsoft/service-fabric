...
namespace EventsStore.EventsModels.Cluster
{
    ...
    [JsonObject("ClusterUpgradeRollbackCompleted")]
    public sealed class ClusterUpgradeRollbackCompleteEvent : ClusterEvent
    {
        public ClusterUpgradeRollbackCompleteEvent(ClusterUpgradeRollbackCompleteTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category)
        {
