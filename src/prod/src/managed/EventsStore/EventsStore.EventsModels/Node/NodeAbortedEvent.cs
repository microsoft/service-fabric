...
namespace EventsStore.EventsModels.Node
{
    ...
    [JsonObject("NodeAborted")]
    public sealed class NodeAbortedEvent : NodeEvent
    {
        public NodeAbortedEvent(NodeAbortedTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.NodeName)
        {
