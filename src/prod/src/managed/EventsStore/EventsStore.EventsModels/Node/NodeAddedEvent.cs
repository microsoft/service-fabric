...
namespace EventsStore.EventsModels.Node
{
    ...
    [JsonObject("NodeAddedToCluster")]
    public sealed class NodeAddedEvent : NodeEvent
    {
        public NodeAddedEvent(NodeAddedTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.NodeName)
        {
