...
namespace EventsStore.EventsModels.Node
{
    ...
    [JsonObject("NodeNewHealthReport")]
    public sealed class NodeHealthReportCreatedEvent : NodeEvent
    {
        public NodeHealthReportCreatedEvent(NodeHealthReportCreatedTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.NodeName)
        {
