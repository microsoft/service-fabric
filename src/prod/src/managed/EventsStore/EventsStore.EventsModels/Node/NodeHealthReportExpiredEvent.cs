...
namespace EventsStore.EventsModels.Node
{
    ...
    [JsonObject("NodeHealthReportExpired")]
    public sealed class NodeHealthReportExpiredEvent : NodeEvent
    {
        public NodeHealthReportExpiredEvent(NodeHealthReportExpiredTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.NodeName)
        {
