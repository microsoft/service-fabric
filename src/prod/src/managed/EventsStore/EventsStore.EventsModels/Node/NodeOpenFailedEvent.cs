...
namespace EventsStore.EventsModels.Node
{
    ...
    [JsonObject("NodeOpenFailed")]
    public sealed class NodeOpenFailedEvent : NodeEvent
    {
        public NodeOpenFailedEvent(NodeOpenedFailedTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.NodeName)
        {
