...
namespace EventsStore.EventsModels.Partition
{
    ...
    [JsonObject("PartitionNewHealthReport")]
    public sealed class PartitionHealthReportCreatedEvent : PartitionEvent
    {
        public PartitionHealthReportCreatedEvent(PartitionHealthReportCreatedTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.PartitionId)
        {
