...
namespace EventsStore.EventsModels.Partition
{
    ...
    [JsonObject("PartitionHealthReportExpired")]
    public sealed class PartitionHealthReportExpiredEvent : PartitionEvent
    {
        public PartitionHealthReportExpiredEvent(PartitionHealthReportExpiredTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.PartitionId)
        {
