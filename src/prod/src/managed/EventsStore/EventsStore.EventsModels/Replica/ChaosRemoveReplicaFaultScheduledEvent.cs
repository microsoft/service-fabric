...
namespace EventsStore.EventsModels.Replica
{
    ...
    [JsonObject("ChaosReplicaRemovalScheduled")]
    public sealed class ChaosRemoveReplicaFaultScheduledEvent : ReplicaEvent
    {
        public ChaosRemoveReplicaFaultScheduledEvent(ChaosRemoveReplicaFaultScheduledTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.PartitionId, traceRecord.ReplicaId)
        {
