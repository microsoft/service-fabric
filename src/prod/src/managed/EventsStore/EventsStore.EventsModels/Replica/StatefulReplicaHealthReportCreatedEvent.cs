...
namespace EventsStore.EventsModels.Replica
{
    ...
    [JsonObject("StatefulReplicaNewHealthReport")]
    public sealed class StatefulReplicaHealthReportCreatedEvent : ReplicaEvent
    {
        public StatefulReplicaHealthReportCreatedEvent(StatefulReplicaHealthReportCreatedTraceRecord traceRecord)
