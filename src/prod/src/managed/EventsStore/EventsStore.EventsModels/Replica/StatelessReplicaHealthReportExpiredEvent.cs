...
namespace EventsStore.EventsModels.Replica
{
    ...
    [JsonObject("StatelessReplicaHealthReportExpired")]
    public sealed class StatelessReplicaHealthReportExpiredEvent : ReplicaEvent
    {
        public StatelessReplicaHealthReportExpiredEvent(StatelessReplicaHealthReportExpiredTraceRecord traceRecord)
