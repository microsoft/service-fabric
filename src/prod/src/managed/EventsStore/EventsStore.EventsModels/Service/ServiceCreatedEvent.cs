...
namespace EventsStore.EventsModels.Service
{
    ...
    [JsonObject("ServiceCreated")]
    public sealed class ServiceCreatedEvent : ServiceEvent
    {
        public ServiceCreatedEvent(ServiceCreatedTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.ServiceName)
        {
            ...
            this.PartitionId = traceRecord.PartitionId;
        }
