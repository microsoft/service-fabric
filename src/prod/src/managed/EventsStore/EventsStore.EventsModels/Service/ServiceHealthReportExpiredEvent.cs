...
namespace EventsStore.EventsModels.Service
{
    ...
    [JsonObject("ServiceHealthReportExpired")]
    public sealed class ServiceHealthReportExpiredEvent : ServiceEvent
    {
        public ServiceHealthReportExpiredEvent(ServiceHealthReportExpiredTraceRecord traceRecord) : base(traceRecord.EventInstanceId, traceRecord.TimeStamp, traceRecord.Category, traceRecord.ServiceName)
        {
