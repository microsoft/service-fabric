...
namespace System.Fabric.UpgradeService
{
    ...
    internal class ApplicationTypeCommandProcessor : ResourceCommandProcessor
    {
        private readonly IFabricClientApplicationWrapper fabricClient;        

        public ApplicationTypeCommandProcessor(IFabricClientApplicationWrapper fabricClient)
        {
            fabricClient.ThrowIfNull(nameof(fabricClient));
            this.fabricClient = fabricClient;
        }

        public override ResourceType Type { get; } = ResourceType.ApplicationType;
        public override TraceType TraceType { get; } = new TraceType("ApplicationTypeCommandProcessor");
            ...
            Exception e)
        {
            ...
            return new ApplicationTypeVersionOperationStatus((ApplicationTypeVersionOperationDescription)description)
            {
