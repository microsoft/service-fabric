...
namespace System.Fabric.UpgradeService
{
    ...
    internal class ServiceCommandProcessor : ResourceCommandProcessor
    {
        private readonly IFabricClientApplicationWrapper fabricClient;

        public ServiceCommandProcessor(IFabricClientApplicationWrapper fabricClient)
        {
            fabricClient.ThrowIfNull(nameof(fabricClient));
            this.fabricClient = fabricClient;
        }
        
        public override ResourceType Type { get; } = ResourceType.Service;
        public override TraceType TraceType { get; } = new TraceType("ServiceCommandProcessor");
            ...
            IOperationContext context)
        {
            ...
            {
                HandleException("CreateOperationStatusAsync", e, this.TraceType);
            }
            ...
            Exception e)
        {
            ...
            return new ServiceOperationStatus((ServiceOperationDescription)description)
            {
