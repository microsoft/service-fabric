...
namespace Microsoft.ServiceFabric.Data.Collections
{
    ...
    /// <summary>
    /// Initialization context for IReliableDictionary (InternalDistributedDictionary).
    /// </summary>
    internal class DictionaryInitializationContext : FileProperties
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="DictionaryInitializationContext"/> class.
        /// </summary>
        public DictionaryInitializationContext()
        {
        }
        ...
        public DictionaryInitializationContext(bool isAutomaticCloningEnabled)
        {
        ...
        /// <summary>
        /// Serialize the <see cref="DictionaryInitializationContext"/> into the given stream.
        /// </summary>
        ...
        public static DictionaryInitializationContext FromByteArray(byte[] bytes)
        {
            if (bytes == null)
            {
            ...
            using (var reader = new BinaryReader(stream))
            {
                ...
                if (version != SerializationVersion)
                {
                    throw new InvalidDataException(
                        string.Format(
                            ...
                            SR.Error_DD_InitializationContext_Deserialized,
                            version,
                ...
                var initializationContext = Read<DictionaryInitializationContext>(reader, handle);
