...
namespace System.Fabric.Store
{
    ...
    /// <summary>
    /// Updated version of an item.
    /// </summary>
    /// <typeparam name="TValue">Type of value for the item.</typeparam>
    internal class TUpdatedItem<TValue> : TVersionedItem<TValue>
    {
        /// <summary>
        ...
        public TUpdatedItem(long versionSequenceNumber, uint fileId, long fileOffset, int valueSize, ulong valueChecksum)
        {
            this.VersionSequenceNumber = versionSequenceNumber;
        ...
        {
            get { return RecordKind.UpdatedVersion; }
        }
    }
}