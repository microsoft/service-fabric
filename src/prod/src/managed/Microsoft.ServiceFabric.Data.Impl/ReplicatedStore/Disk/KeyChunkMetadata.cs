...
namespace System.Fabric.Store
{
    ...
    /// </devnote>
    internal struct KeyChunkMetadata
    {
        /// <summary>
        ...
        public KeyChunkMetadata(int blockSize)
        {
            this.BlockSize = blockSize;
        }

        public static KeyChunkMetadata Read(InMemoryBinaryReader reader)
        {
            ...
            return new KeyChunkMetadata(currentBlockSize);
        }
