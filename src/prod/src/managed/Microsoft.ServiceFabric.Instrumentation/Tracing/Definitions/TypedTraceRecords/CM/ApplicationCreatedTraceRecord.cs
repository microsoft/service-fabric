...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.CM
{
    ...
    [DataContract]
    public sealed class ApplicationCreatedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ApplicationCreatedTraceRecord, CancellationToken, Task> onOccurrence;

        public ApplicationCreatedTraceRecord(Func<ApplicationCreatedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            29620,
            TaskName.CM)
        {
        ...
        [TraceField(6, OriginalName = "applicationDefinitionKind")]
        public ApplicationDefinitionKind ApplicationDefinitionKind
        {
            get { return (ApplicationDefinitionKind)this.PropertyValueReader.ReadInt32At(6); }
        }
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ApplicationCreatedTraceRecord, CancellationToken, Task>)value; }
        }
        ...
        public override string ToString()
        {
            return string.Format(
               ...
               "TimeStamp : {0}, TracingProcessId : {1}, ThreadId : {2}, Level : {3}, EventName : {4}, Category : {5}, EventInstanceId : {6}, ApplicationName : {7}, ApplicationTypeName : {8}, ApplicationTypeVersion : {9}, ApplicationDefinitionKind : {10}",
                this.TimeStamp,
