...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.CM
{
    ...
    [DataContract]
    public sealed class ApplicationUpgradeCompleteTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ApplicationUpgradeCompleteTraceRecord, CancellationToken, Task> onOccurrence;

        public ApplicationUpgradeCompleteTraceRecord(Func<ApplicationUpgradeCompleteTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            29622,
            TaskName.CM)
        {
        ...
        [TraceField(6, OriginalName = "overallUpgradeElapsedTimeInMs")]
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ApplicationUpgradeCompleteTraceRecord, CancellationToken, Task>)value; }
        }
        ...
        public override string ToString()
        {
            return string.Format(
               ...
               "TimeStamp : {0}, TracingProcessId : {1}, ThreadId : {2}, Level : {3}, EventName : {4}, Category : {5}, EventInstanceId : {6}, ApplicationName : {7}, ApplicationTypeName : {8}, ApplicationTypeVersion : {9}, OverallUpgradeElapsedTimeInMs : {10}",
                this.TimeStamp,
