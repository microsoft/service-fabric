...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.CM
{
    ...
    [DataContract]
    public sealed class ClusterUpgradeRollbackStartTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ClusterUpgradeRollbackStartTraceRecord, CancellationToken, Task> onOccurrence;

        public ClusterUpgradeRollbackStartTraceRecord(Func<ClusterUpgradeRollbackStartTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            29629,
            TaskName.CM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ClusterUpgradeRollbackStartTraceRecord, CancellationToken, Task>)value; }
        }
