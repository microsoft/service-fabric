...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.FM
{
    ...
    [DataContract]
    public sealed class NodeAddedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<NodeAddedTraceRecord, CancellationToken, Task> onOccurrence;

        public NodeAddedTraceRecord(Func<NodeAddedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            18605,
            TaskName.FM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<NodeAddedTraceRecord, CancellationToken, Task>)value; }
        }
