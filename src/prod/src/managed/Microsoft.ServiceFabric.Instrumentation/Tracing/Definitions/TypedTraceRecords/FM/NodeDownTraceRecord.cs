...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.FM
{
    ...
    [DataContract]
    public sealed class NodeDownTraceRecord : StronglyTypedTraceRecord
    {
        private Func<NodeDownTraceRecord, CancellationToken, Task> onOccurrence;

        public NodeDownTraceRecord(Func<NodeDownTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            18604,
            TaskName.FM)
        {
        ...
        [TraceField(5, OriginalName = "lastNodeUpAt")]
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<NodeDownTraceRecord, CancellationToken, Task>)value; }
        }
        ...
        public override string ToString()
        {
            return string.Format(
               ...
               "TimeStamp : {0}, TracingProcessId : {1}, ThreadId : {2}, Level : {3}, EventName : {4}, Category : {5}, EventInstanceId : {6}, NodeName : {7}, NodeInstance : {8}, LastNodeUpAt : {9}",
                this.TimeStamp,
