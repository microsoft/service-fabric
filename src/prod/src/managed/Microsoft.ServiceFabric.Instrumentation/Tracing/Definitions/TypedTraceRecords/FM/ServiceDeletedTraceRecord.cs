...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.FM
{
    ...
    [DataContract]
    public sealed class ServiceDeletedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ServiceDeletedTraceRecord, CancellationToken, Task> onOccurrence;

        public ServiceDeletedTraceRecord(Func<ServiceDeletedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            18658,
            TaskName.FM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ServiceDeletedTraceRecord, CancellationToken, Task>)value; }
        }
        ...
        public override string ToString()
        {
            return string.Format(
               ...
               "TimeStamp : {0}, TracingProcessId : {1}, ThreadId : {2}, Level : {3}, EventName : {4}, Category : {5}, EventInstanceId : {6}, ServiceName : {7}, ServiceTypeName : {8}, ApplicationName : {9}, ApplicationTypeName : {10}, ServiceInstance : {11}, IsStateful : {12}, PartitionCount : {13}, TargetReplicaSetSize : {14}, MinReplicaSetSize : {15}, ServicePackageVersion : {16}",
                this.TimeStamp,
