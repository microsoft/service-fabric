...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.FabricNode
{
    ...
    [DataContract]
    public sealed class NodeOpenedFailedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<NodeOpenedFailedTraceRecord, CancellationToken, Task> onOccurrence;

        public NodeOpenedFailedTraceRecord(Func<NodeOpenedFailedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            25622,
            TaskName.FabricNode)
        {
        ...
        [TraceField(12, OriginalName = "error")]
        public ErrorCodeValue Error
        {
            get { return (ErrorCodeValue)this.PropertyValueReader.ReadInt32At(12); }
        }
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<NodeOpenedFailedTraceRecord, CancellationToken, Task>)value; }
        }
        ...
        public override string ToString()
        {
            return string.Format(
               ...
               "TimeStamp : {0}, TracingProcessId : {1}, ThreadId : {2}, Level : {3}, EventName : {4}, Category : {5}, EventInstanceId : {6}, NodeName : {7}, NodeInstance : {8}, NodeId : {9}, UpgradeDomain : {10}, FaultDomain : {11}, IpAddressOrFQDN : {12}, Hostname : {13}, IsSeedNode : {14}, NodeVersion : {15}, Error : {16}",
                this.TimeStamp,
