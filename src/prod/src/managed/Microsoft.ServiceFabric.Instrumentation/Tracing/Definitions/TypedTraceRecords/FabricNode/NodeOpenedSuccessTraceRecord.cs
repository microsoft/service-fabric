...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.FabricNode
{
    ...
    [DataContract]
    public sealed class NodeOpenedSuccessTraceRecord : StronglyTypedTraceRecord
    {
        private Func<NodeOpenedSuccessTraceRecord, CancellationToken, Task> onOccurrence;

        public NodeOpenedSuccessTraceRecord(Func<NodeOpenedSuccessTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            25621,
            TaskName.FabricNode)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<NodeOpenedSuccessTraceRecord, CancellationToken, Task>)value; }
        }
