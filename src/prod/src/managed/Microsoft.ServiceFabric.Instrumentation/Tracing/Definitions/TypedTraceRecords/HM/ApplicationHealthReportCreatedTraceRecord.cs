...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class ApplicationHealthReportCreatedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ApplicationHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurrence;

        public ApplicationHealthReportCreatedTraceRecord(Func<ApplicationHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54425,
            TaskName.HM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ApplicationHealthReportCreatedTraceRecord, CancellationToken, Task>)value; }
        }
        ...
        public override string ToString()
        {
            return string.Format(
               ...
               "TimeStamp : {0}, TracingProcessId : {1}, ThreadId : {2}, Level : {3}, EventName : {4}, Category : {5}, EventInstanceId : {6}, ApplicationName : {7}, ApplicationInstanceId : {8}, SourceId : {9}, Property : {10}, HealthState : {11}, TTLTimespan : {12}, SequenceNumber : {13}, Description : {14}, RemoveWhenExpired : {15}, SourceUtcTimestamp : {16}",
                this.TimeStamp,
