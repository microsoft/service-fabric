...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class ApplicationHealthReportExpiredTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ApplicationHealthReportExpiredTraceRecord, CancellationToken, Task> onOccurrence;

        public ApplicationHealthReportExpiredTraceRecord(Func<ApplicationHealthReportExpiredTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54434,
            TaskName.HM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ApplicationHealthReportExpiredTraceRecord, CancellationToken, Task>)value; }
        }
