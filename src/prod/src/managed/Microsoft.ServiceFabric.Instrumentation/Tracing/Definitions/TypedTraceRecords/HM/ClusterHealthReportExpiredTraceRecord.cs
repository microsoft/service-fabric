...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class ClusterHealthReportExpiredTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ClusterHealthReportExpiredTraceRecord, CancellationToken, Task> onOccurrence;

        public ClusterHealthReportExpiredTraceRecord(Func<ClusterHealthReportExpiredTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54437,
            TaskName.HM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ClusterHealthReportExpiredTraceRecord, CancellationToken, Task>)value; }
        }
