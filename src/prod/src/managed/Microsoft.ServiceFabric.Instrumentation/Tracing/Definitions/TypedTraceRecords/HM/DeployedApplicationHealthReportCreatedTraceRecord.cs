...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class DeployedApplicationHealthReportCreatedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<DeployedApplicationHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurrence;

        public DeployedApplicationHealthReportCreatedTraceRecord(Func<DeployedApplicationHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54426,
            TaskName.HM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<DeployedApplicationHealthReportCreatedTraceRecord, CancellationToken, Task>)value; }
        }
