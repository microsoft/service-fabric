...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class DeployedServiceHealthReportExpiredTraceRecord : StronglyTypedTraceRecord
    {
        private Func<DeployedServiceHealthReportExpiredTraceRecord, CancellationToken, Task> onOccurrence;

        public DeployedServiceHealthReportExpiredTraceRecord(Func<DeployedServiceHealthReportExpiredTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54436,
            TaskName.HM)
        {
        ...
        [TraceField(4, OriginalName = "serviceManifest")]
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<DeployedServiceHealthReportExpiredTraceRecord, CancellationToken, Task>)value; }
        }
        ...
        public override string ToString()
        {
            return string.Format(
               ...
               "TimeStamp : {0}, TracingProcessId : {1}, ThreadId : {2}, Level : {3}, EventName : {4}, Category : {5}, EventInstanceId : {6}, ApplicationName : {7}, ServiceManifest : {8}, ServicePackageInstanceId : {9}, ServicePackageActivationId : {10}, NodeName : {11}, SourceId : {12}, Property : {13}, HealthState : {14}, TTLTimespan : {15}, SequenceNumber : {16}, Description : {17}, RemoveWhenExpired : {18}, SourceUtcTimestamp : {19}",
                this.TimeStamp,
