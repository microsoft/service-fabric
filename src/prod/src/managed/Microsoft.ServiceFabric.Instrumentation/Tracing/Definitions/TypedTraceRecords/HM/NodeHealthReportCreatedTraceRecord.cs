...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class NodeHealthReportCreatedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<NodeHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurrence;

        public NodeHealthReportCreatedTraceRecord(Func<NodeHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54423,
            TaskName.HM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<NodeHealthReportCreatedTraceRecord, CancellationToken, Task>)value; }
        }
