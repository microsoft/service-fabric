...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class PartitionHealthReportExpiredTraceRecord : StronglyTypedTraceRecord
    {
        private Func<PartitionHealthReportExpiredTraceRecord, CancellationToken, Task> onOccurrence;

        public PartitionHealthReportExpiredTraceRecord(Func<PartitionHealthReportExpiredTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54431,
            TaskName.HM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<PartitionHealthReportExpiredTraceRecord, CancellationToken, Task>)value; }
        }
