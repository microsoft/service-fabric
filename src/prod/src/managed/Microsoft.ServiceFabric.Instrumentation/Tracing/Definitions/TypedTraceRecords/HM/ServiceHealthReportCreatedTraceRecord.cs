...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class ServiceHealthReportCreatedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ServiceHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurrence;

        public ServiceHealthReportCreatedTraceRecord(Func<ServiceHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54424,
            TaskName.HM)
        {
        ...
        [TraceField(4, OriginalName = "instanceId")]
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ServiceHealthReportCreatedTraceRecord, CancellationToken, Task>)value; }
        }
        ...
        public override string ToString()
        {
            return string.Format(
               ...
               "TimeStamp : {0}, TracingProcessId : {1}, ThreadId : {2}, Level : {3}, EventName : {4}, Category : {5}, EventInstanceId : {6}, ServiceName : {7}, InstanceId : {8}, SourceId : {9}, Property : {10}, HealthState : {11}, TTLTimespan : {12}, SequenceNumber : {13}, Description : {14}, RemoveWhenExpired : {15}, SourceUtcTimestamp : {16}",
                this.TimeStamp,
