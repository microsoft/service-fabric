...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class ServiceHealthReportExpiredTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ServiceHealthReportExpiredTraceRecord, CancellationToken, Task> onOccurrence;

        public ServiceHealthReportExpiredTraceRecord(Func<ServiceHealthReportExpiredTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54433,
            TaskName.HM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ServiceHealthReportExpiredTraceRecord, CancellationToken, Task>)value; }
        }
