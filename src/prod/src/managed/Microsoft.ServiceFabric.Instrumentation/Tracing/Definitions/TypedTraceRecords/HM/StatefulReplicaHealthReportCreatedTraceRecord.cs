...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class StatefulReplicaHealthReportCreatedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<StatefulReplicaHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurrence;

        public StatefulReplicaHealthReportCreatedTraceRecord(Func<StatefulReplicaHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54429,
            TaskName.HM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<StatefulReplicaHealthReportCreatedTraceRecord, CancellationToken, Task>)value; }
        }
