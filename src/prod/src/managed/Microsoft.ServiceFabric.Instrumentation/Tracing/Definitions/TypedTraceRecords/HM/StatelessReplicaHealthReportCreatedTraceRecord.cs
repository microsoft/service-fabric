...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.HM
{
    ...
    [DataContract]
    public sealed class StatelessReplicaHealthReportCreatedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<StatelessReplicaHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurrence;

        public StatelessReplicaHealthReportCreatedTraceRecord(Func<StatelessReplicaHealthReportCreatedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            54430,
            TaskName.HM)
        {
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<StatelessReplicaHealthReportCreatedTraceRecord, CancellationToken, Task>)value; }
        }
