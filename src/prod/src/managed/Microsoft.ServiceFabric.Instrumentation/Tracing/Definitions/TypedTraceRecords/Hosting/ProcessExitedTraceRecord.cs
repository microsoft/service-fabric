...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.Hosting
{
    ...
    [DataContract]
    public sealed class ProcessExitedTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ProcessExitedTraceRecord, CancellationToken, Task> onOccurrence;

        public ProcessExitedTraceRecord(Func<ProcessExitedTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            23083,
            TaskName.Hosting)
        {
        ...
        [TraceField(10, OriginalName = "ExeName")]
        public string ExeName
        {
            get { return this.PropertyValueReader.ReadUnicodeStringAt(10); }
        }

        [TraceField(11, OriginalName = "ProcessId")]
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ProcessExitedTraceRecord, CancellationToken, Task>)value; }
        }
