...
namespace Microsoft.ServiceFabric.Instrumentation.Tracing.Definitions.TypedTraceRecords.Testability
{
    ...
    [DataContract]
    public sealed class ChaosRestartReplicaFaultScheduledTraceRecord : StronglyTypedTraceRecord
    {
        private Func<ChaosRestartReplicaFaultScheduledTraceRecord, CancellationToken, Task> onOccurrence;

        public ChaosRestartReplicaFaultScheduledTraceRecord(Func<ChaosRestartReplicaFaultScheduledTraceRecord, CancellationToken, Task> onOccurenceAction) : base(
            50047,
        ...
        public override Delegate Target
        {
            ...
            protected set { this.onOccurrence = (Func<ChaosRestartReplicaFaultScheduledTraceRecord, CancellationToken, Task>)value; }
        }
