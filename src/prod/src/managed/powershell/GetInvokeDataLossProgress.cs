...
namespace Microsoft.ServiceFabric.Powershell
{
    ...
    [Cmdlet(VerbsCommon.Get, "ServiceFabricPartitionDataLossProgress")]
    public sealed class GetInvokeDataLossProgress : CommonCmdletBase
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                var invokeDataLossProgress = clusterConnection.GetInvokeDataLossProgressAsync(
                                                 this.OperationId,
                                                 this.GetTimeout(),
            ...
            catch (AggregateException aggregateException)
            {
                aggregateException.Handle((ae) =>
                {
                    this.ThrowTerminatingError(
                        ae,
                        Constants.GetInvokeDataLossProgressCommandErrorId,
                        clusterConnection);
                    return true;
                });
            }
        ...
        {
            var item = output as System.Fabric.PartitionDataLossProgress;
