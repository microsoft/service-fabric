...
namespace Microsoft.ServiceFabric.Powershell
{
    ...
    [Cmdlet(VerbsCommon.Get, "ServiceFabricPartitionQuorumLossProgress")]
    public sealed class GetInvokeQuorumLossProgress : CommonCmdletBase
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                var invokeDataLossProgress = clusterConnection.GetInvokeQuorumLossProgressAsync(
                                                 this.OperationId,
                                                 this.GetTimeout(),
            ...
            catch (AggregateException aggregateException)
            {
                aggregateException.Handle((ae) =>
                {
                    this.ThrowTerminatingError(
                        ae,
                        Constants.GetInvokeQuorumLossProgressCommandErrorId,
                        clusterConnection);
                    return true;
                });
            }
        ...
        {
            var item = output as System.Fabric.PartitionQuorumLossProgress;
