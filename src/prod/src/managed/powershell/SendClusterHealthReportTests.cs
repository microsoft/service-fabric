...
namespace Microsoft.ServiceFabric.Powershell
{
    ...
    [TestClass]
    public class SendClusterHealthReportTests : TestHealthReportHelper
    {
        [ClassInitialize]
        ...
        public SendClusterHealthReportTests()
        {
            SetDefaultValues();
        }
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendClusterHealthTestPositionalParameterPositive()
        {
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendClusterHealthTestExceptionNegative()
        {
            /// Set default values
            this.SetDefaultValues();
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendClusterHealthTestOptionalParameterPositive()
        {
            /// Set default values
            this.SetDefaultValues();
        ...
        public string CreateCmdletScript()
        {
            string cmdScript = string.Format(
                                   ...
                                   "{0} {1}",
                                   TestConstants.SendClusterHealthCommand,
        ...
        override public bool InvokeCmdletAndVerify()
        {
            ...
            this.mockClusterConnection.healthReport =
                new ClusterHealthReport(base.healthInformation);
