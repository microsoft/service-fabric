...
namespace Microsoft.ServiceFabric.Powershell
{
    ...
    [TestClass]
    public class SendDeployedApplicationHealthReportTests : TestHealthReportHelper
    {
        [ClassInitialize]
        ...
        public SendDeployedApplicationHealthReportTests()
        {
            SetDefaultValues();
        }
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendDeployedApplicationHealthTestPositionalParameterPositive()
        {
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendDeployedApplicationHealthTestExceptionNegative()
        {
            /// Set default values
            this.SetDefaultValues();
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendDeployedApplicationHealthTestOptionalParameterPositive()
        {
            /// Set default values
            this.SetDefaultValues();
        ...
        public string CreateCmdletScript()
        {
            string cmdScript = string.Format(
                ...
                "{0} {1} {2} {3}", /// send-health-report-command, appname, nodename, HealthInformation's args
                TestConstants.SendDeployedApplicationHealthCommand,
                testApplicationUri,
                testNodeName,
        ...
        override public bool InvokeCmdletAndVerify()
        {
            ...
            this.mockClusterConnection.healthReport =
                new DeployedApplicationHealthReport(testApplicationUri, testNodeName, base.healthInformation);
