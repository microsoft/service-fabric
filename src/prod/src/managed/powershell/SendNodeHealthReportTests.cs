...
namespace Microsoft.ServiceFabric.Powershell
{
    ...
    [TestClass]
    public class SendNodeHealthReportTests : TestHealthReportHelper
    {
        [ClassInitialize]
        ...
        public SendNodeHealthReportTests()
        {
            SetDefaultValues();
        }
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendNodeHealthTestPositionalParameterPositive()
        {
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendNodeHealthTestExceptionNegative()
        {
            /// Set default values
            this.SetDefaultValues();
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendNodeHealthTestOptionalParameterPositive()
        {
            /// Set default values
            this.SetDefaultValues();
        ...
        {
            /// send-health-report-command, nodename, HealthInformation's args
            string cmdScript = string.Format(
                CultureInfo.InvariantCulture,
                "{0} {1} {2} ",
                TestConstants.SendNodeHealthCommand,
                testNodeName,
        ...
        override public bool InvokeCmdletAndVerify()
        {
            ...
            this.mockClusterConnection.healthReport =
                new NodeHealthReport(testNodeName, base.healthInformation);
