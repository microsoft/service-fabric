...
namespace Microsoft.ServiceFabric.Powershell
{
    ...
    [TestClass]
    public class SendPartitionHealthReportTests : TestHealthReportHelper
    {
        [ClassInitialize]
        ...
        public SendPartitionHealthReportTests()
        {
            SetDefaultValues();
        }
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendPartitionHealthTestPositionalParameterPositive()
        {
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendPartitionHealthTestExceptionNegative()
        {
            /// Set default values
            this.SetDefaultValues();
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendPartitionHealthTestOptionalParameterPositive()
        {
            /// Set default values
            this.SetDefaultValues();
        ...
        {
            /// send-health-report-command, partition-id, HealthInformation's args
            string cmdScript = string.Format(
                CultureInfo.InvariantCulture,
                "{0} {1} {2} ", 
                TestConstants.SendPartitionHealthCommand,
                testPartitionId,
        ...
        override public bool InvokeCmdletAndVerify()
        {
            ...
            this.mockClusterConnection.healthReport =
                new PartitionHealthReport(testPartitionId, base.healthInformation);
