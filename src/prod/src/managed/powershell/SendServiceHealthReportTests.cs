...
namespace Microsoft.ServiceFabric.Powershell
{
    ...
    [TestClass]
    public class SendServiceHealthReportTests : TestHealthReportHelper
    {
        [ClassInitialize]
        ...
        public static readonly Uri testServiceNameDefault = new Uri("fabric:/testapp/myDefaultServiceName");

        public Uri testServiceName
        {
            get;
            set;
        }

        public SendServiceHealthReportTests()
        {
            SetDefaultValues();
        }
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendServiceHealthTestPositionalParameterPositive()
        {
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendServiceHealthTestExceptionNegative()
        {
            /// Set default values
            this.SetDefaultValues();
        ...
        [TestMethod]
        [Owner("vikkuma")]
        public void SendServiceHealthTestOptionalParameterPositive()
        {
            /// Set default values
            this.SetDefaultValues();
        ...
        {
            /// send-health-report-command, service-name, HealthInformation's args
            string cmdScript = string.Format(
                CultureInfo.InvariantCulture,
                "{0} {1} {2} ",
                TestConstants.SendServiceHealthCommand,
                testServiceName,
        ...
        override public bool InvokeCmdletAndVerify()
        {
            ...
            this.mockClusterConnection.healthReport =
                new ServiceHealthReport(testServiceName, base.healthInformation);
        ...
        override public void SetDefaultValues()
        {
            ...
            this.testServiceName = testServiceNameDefault;
        }
    }
}