...
#define EXE_RESOURCE( ResourceProperty, ResourceName ) \
    DEFINE_STRING_RESOURCE( FabricGatewayResource, ResourceProperty, FABRICGATEWAY, ResourceName ) \

    class FabricGatewayResource
    {
        DECLARE_SINGLETON_RESOURCE( FabricGatewayResource )
