    ...
    /* [out, retval] */ __RPC__deref_out_opt void ** fabricInfrastructureServiceAgent)
{
    ...
    auto factoryPtr = Management::InfrastructureService::InfrastructureServiceAgentFactory::Create();

    Api::ComInfrastructureServiceAgentFactory comFactory(factoryPtr);

    return comFactory.CreateFabricInfrastructureServiceAgent(riid, fabricInfrastructureServiceAgent);
}
