...
namespace TStoreLonghaul
{
    ...
    private:
        ...
        ktl::Awaitable<void> VerifyConcurrentCreationDeletionWithTransactionOnStoresAsync();
        ktl::Awaitable<void> VerifyConcurrentCreationWithTransactionOnStoresAsync();
        ktl::Awaitable<void> VerifyStoreCreationWithTransactionsOnStoreAsync();

        ktl::Awaitable<bool> DoesStoresMatchTheCountingStore(KSharedPtr<Data::TStore::IStore<LONG64, KString::SPtr>> store);
    ...
    private:
        const wchar_t prefixCharacters[26] = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z' };
