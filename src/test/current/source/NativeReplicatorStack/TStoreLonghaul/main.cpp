...
int main() 
{
    ...
    ComPointer<ComFactory> comFactory = make_com<ComFactory>(L"TStoreLonghaulServiceType", *factory.get());
    ComPointer<ComFactory> comVolatileFactory = make_com<ComFactory>(L"TStoreLonghaulVolatileServiceType", *factory.get());
    ...
    fabricRuntime->RegisterStatefulServiceFactory(
        L"TStoreLonghaulServiceType",
        comFactory.GetRawPointer());

    fabricRuntime->RegisterStatefulServiceFactory(
        L"TStoreLonghaulVolatileServiceType",
