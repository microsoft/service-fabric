...
apt-get install -y libcgroup-dev cgroup-bin libunwind8-dev
...
#dotnet
curl https://download.visualstudio.microsoft.com/download/pr/e5eef3df-d2e3-429b-8204-f58372eb6263/20c825ddcc6062e93ff0c60e8354d3af/dotnet-sdk-2.1.500-linux-x64.tar.gz --output /tmp/dotnet-sdk-2.1.500-linux-x64.tar.gz
if [ -d /usr/share/dotnet ]; then
  rm -rf /usr/share/dotnet;
fi
mkdir -p /usr/share/dotnet && tar zxf /tmp/dotnet-sdk-2.1.500-linux-x64.tar.gz -C /usr/share/dotnet
